...
*
* The expand function is called expand_message in RFC 9380 and could for the
* curves implemented here should usually be XMD, but expand_message_xof is also
* allowed by the RFC (though this is not implemented currently)
*
* For details see RFC 9380 sections 3, 5.2 and 6.6.2.
*/
template <typename C, bool RO, typename ExpandMsg>
   requires C::ValidForSswuHash
