...
*/
std::optional<BigInt> BOTAN_TEST_API inverse_modulo_general(const BigInt& x, const BigInt& m);
...
*/
BigInt BOTAN_TEST_API inverse_modulo_secret_prime(const BigInt& x, const BigInt& p);
...
* or if p is even or less than 3.
*/
BigInt BOTAN_TEST_API inverse_modulo_public_prime(const BigInt& x, const BigInt& p);
