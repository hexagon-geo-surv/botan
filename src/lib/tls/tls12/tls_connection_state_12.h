...
class Active_Connection_State_12 final {
   public:
      ...
      Active_Connection_State_12(Protocol_Version version,
       ...
       */
      Handshake_IO* dtls_handshake_io() { return m_dtls_handshake_io.get(); }

      void set_dtls_handshake_io(std::unique_ptr<Handshake_IO> io);
   ...
   private:
      ...
      std::unique_ptr<Handshake_IO> m_dtls_handshake_io;
};
