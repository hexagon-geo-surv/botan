...
void TLS_CBC_HMAC_AEAD_Mode::set_ad_n(size_t /* ignored */, std::span<const uint8_t> ad)
   {
   if(ad.size() != 13)
...
void TLS_CBC_HMAC_AEAD_Encryption::set_ad_n(size_t /* ignored */, std::span<const uint8_t> ad)
   {
