...
class BOTAN_PUBLIC_API(2, 0) EC_Group final {
   public:
      ...
      */
      BOTAN_DEPRECATED("Use EC_Group::from_OID")

      explicit EC_Group(const OID& oid) { *this = EC_Group::from_OID(oid); }
      ...
      */
      BOTAN_DEPRECATED("Use EC_Group::from_{name,OID,PEM}")
      ...
      */
      ...
      BOTAN_DEPRECATED("Use EC_Group::from_PEM")

      static EC_Group EC_Group_from_PEM(std::string_view pem) { return EC_Group::from_PEM(pem); }
      ...
      */
      BOTAN_DEPRECATED("Deprecated - use OS2ECP")
      ...
      */
      ...
      BOTAN_DEPRECATED("Just serialize the point and check")
