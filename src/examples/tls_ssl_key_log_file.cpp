...
class Server_Credential : public Botan::Credentials_Manager {
   public:
      ...
      std::vector<Botan::X509_Certificate> cert_chain(
         ...
         unused(cert_signature_schemes, type, context);
...
class BotanTLSCallbacksProxy : public Botan::TLS::Callbacks {
   ...
   public:
      ...
      void tls_record_received(uint64_t seq_no, std::span<const uint8_t> data) override { unused(seq_no, data); }

      void tls_alert(Botan::TLS::Alert alert) override { unused(alert); }
